            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-lg-12 col-md-12 col-sm-12">
                        ...
                        <h3 style="color: #292929;font-family: Roboto, Sans-serif;font-weight: 700; font-size: 30px; margin-top:5px;margin-bottom:5px;">Project Logistics</h3>

                        <p style="color: #54595F;font-family: Roboto, Sans-serif;font-weight: 400;margin-bottom:5px;font-size: 18px;"><?php echo $row['defination'] ?> </p>
