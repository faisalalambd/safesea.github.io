    ...
    <div class="row">
        ...
        ?>
                <div class="col-12 col-lg-12 col-md-12 col-sm-12" style="margin-right:0px ;">
                    <img src="../admin/assets/image/<?php echo $row['image'] ?>" alt="" width="100%">
                </div>
        <?php }
        } ?>
        ...
        <section style="background-color:#F3F4F3">
            <div class="row">
                <div class="col-12 col-lg-12 col-md-12 col-sm-12">
                    ...
                    <h3 style="text-align: center; color: #54595F;font-family: Roboto, Sans-serif;font-weight: 700;font-size: 25px; margin-top:5px;margin-bottom:5px;">OUR MEMBERSHIP</h3>

                    <p class="container" style=" text-align: center;color: #54595F;font-family: Roboto, Sans-serif; font-size: 18px;font-weight: 400; margin-bottom:5px;"> </p>
...
<section>
    ...
    <div class="row" style="margin-bottom: 20px;margin-left: 40px;margin-right: 40px;">
        ...
        ?>
                <div class="col-lg-7 col-md-2 col-sm-2 col-xs-12" style="padding: 5px;">
                    <div class="single-we-do-box text-center" style="min-height: 10rem;">
                        <div class="we-do-description" style="padding-top: 4rem;padding-bottom: 2rem;">
                            <div class="we-do-info">
                                <div class="we-do-img">
                                    <img src="../admin/assets/image/<?php echo $row['image'] ?>" alt="image of business" style="width: 100%;" />
                                </div>
                                <!--/.we-do-img-->
...
<section>
    ...
    <div class="row" style="margin-bottom: 20px;padding: 0 3rem;">
        ...
        ?>
                <div class="col-lg-7 col-md-2 col-sm-2 col-xs-12" style="padding: 5px;">
                    <div class="single-we-do-box text-center" style="background-color: <?php echo $row['background_color'] ?>; min-height: 10rem;">
                        <div class="we-do-description" style="padding-top: 4rem;padding-bottom: 2rem;">
                            <div class="we-do-info">
                                <div class="we-do-img">
