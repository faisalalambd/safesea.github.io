                ...
                <div class="card">
                    ...
                    <form action="news_store.php" method="post">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label"><strong>Redirection Link</strong></label>
                                <div class="col-sm-9">
                             <input type="text" class="form-control" placeholder="Title" value="" name="link" required>
                                </div>
                            </div>
