...
?>
        ...
        <section style="background-color:#E8F1EC;">
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <img src="../admin/assets/image/<?php echo $row['image'] ?>" alt="about banner" style="width: 100%; height: 45rem;">
                </div>
            </div>
        </section>
        ...
        <section style="background-color:#E8F1EC;">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <h3 style="color:black; font-weight: bold;font-size:30px;line-height:26px; margin:25px 0 20px 0;">About Us</h3>
