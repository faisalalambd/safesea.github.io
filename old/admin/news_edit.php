                ...
                <div class="card">
                    ...
                    <form action="news_update.php?id=<?php echo $id ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label"><strong>Rediection Link</strong></label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" placeholder="link" value="<?php echo $link?>" name="link" required>
                                </div>
                            </div>
