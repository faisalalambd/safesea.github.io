            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <h4>Form: <?php echo $title?></h4>
                    </div>


                    <!-- ############################## Form ############################## -->
                    <form action="service_store.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="summernote" value="" name="defination" required></textarea>
                                </div>
                            </div>
